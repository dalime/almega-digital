...
export default function Hero(props: Props): JSX.Element {
	...
	return (
		<div style={{ width: '100vw', position: 'relative', textAlign: 'center', }} className="hero-parallax">
			...
			<div style={{ position: 'absolute', top: mobile ? '80%' : '65%', left: '50%', transform: 'translate(-50%, -50%)', width: mobile ? '100%' : 'auto', padding: mobile ? 12 : 0, }}><Checks mobile={mobile} hero={true} /></div>
		</div>
	)
}
