...
export const getServicePackages = (pck: string): ServicePackage[] => {
  switch (pck) {
    case 'design':
      return [uiDesign, uxResearch, interactivePrototype]
    case 'web':
      return [websiteBuilder, eCommerce, customWebsite]
    case 'app':
      return [webApp, mobileApp]
    default:
      return []
  }
}